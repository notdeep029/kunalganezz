...
const serverHost = process.env.SERVER_HOST || 'PlayNotMc.aternos.me';
const serverPort = parseInt(process.env.SERVER_PORT || '24181', 10);
const botUsername = process.env.BOT_USERNAME || 'kunalgamerzz';
